...
public abstract class AbstractItemCountingItemStreamItemReader<T> extends AbstractItemStreamItemReader<T> {
    ...
    protected long getCurrentItemCount() {
     ...
     * @see #setName(String)
     */
    public void setCurrentItemCount(long count) {
     ...
     * @see #setName(String)
     */
    public void setMaxItemCount(long count) {
    ...
    public void open(ExecutionContext executionContext) throws ItemStreamException {
        ...
        if (executionContext.containsKey(getExecutionContextKey(READ_COUNT_MAX))) {
            maxItemCount = executionContext.getLong(getExecutionContextKey(READ_COUNT_MAX));
        }

        long itemCount = currentItemCount;
        currentItemCount = 0;
        try {
            //Jump to current item count
    ...
    public void update(ExecutionContext executionContext) throws ItemStreamException {
        ...
        if (saveState) {
            ...
            executionContext.putLong(getExecutionContextKey(READ_COUNT), currentItemCount);
            if (maxItemCount < Integer.MAX_VALUE) {
                executionContext.putLong(getExecutionContextKey(READ_COUNT_MAX), maxItemCount);
            }
        }
